      ...
      <main className="flex-1 lg:ml-64 flex flex-col min-w-0">
        ...
        <div className="p-4 lg:p-8 flex-1 overflow-x-hidden">
          <Routes>
            ...
            {isAdmin && (
              <>
                <Route path="/operators" element={<OperatorsList operators={operators} onUpdate={handleUpdateOperators} userRole={userRole!} />} />
            ...
            {!isAdmin && (
              <>
                <Route path="/my-profile" element={<OperatorDetail operators={operators} onUpdate={handleUpdateOperators} userRole={userRole!} goals={goals} />} />
                <Route path="/operator/:id" element={<OperatorDetail operators={operators} onUpdate={handleUpdateOperators} userRole={userRole!} goals={goals} />} />
              </>
            )}
